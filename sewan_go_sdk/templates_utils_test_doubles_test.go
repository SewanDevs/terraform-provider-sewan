...
func (templaterFake Unexisting_template_TemplaterFake) UpdateSchema(d *schema.ResourceData,
  template map[string]interface{},
  templatesTooler *TemplatesTooler) error {

  return nil
}
func (templaterFake Unexisting_template_TemplaterFake) UpdateSchemaDisks(d *schema.ResourceData,
  disks []interface{}) error {

  return nil
}
func (templaterFake Unexisting_template_TemplaterFake) UpdateSchemaNics(d *schema.ResourceData) error {
...
func (templaterFake EXISTING_TEMPLATE_WITH_ADDITIONAL_AND_MODIFIED_NICS_AND_DISKS_VM_MAP_TemplaterFake) UpdateSchema(d *schema.ResourceData,
  template map[string]interface{},
  templatesTooler *TemplatesTooler) error {
...
func (templaterFake EXISTING_TEMPLATE_WITH_ADDITIONAL_AND_MODIFIED_NICS_AND_DISKS_VM_MAP_TemplaterFake) UpdateSchemaDisks(d *schema.ResourceData,
  disks []interface{}) error {

  return nil
}
func (templaterFake EXISTING_TEMPLATE_WITH_ADDITIONAL_AND_MODIFIED_NICS_AND_DISKS_VM_MAP_TemplaterFake) UpdateSchemaNics(d *schema.ResourceData) error {
