---
layout: "sewan"
page_title: "Sewan: cloudinit_multipart"
sidebar_current: "docs-sewan-datasource-cloudinit-config"
description: |-
...
* `part` - (Required) One may specify this many times, this creates a fragment of the rendered cloud-init config file. The order of the parts is maintained in the configuration is maintained in the rendered sewan.
