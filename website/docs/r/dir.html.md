---
layout: "sewan"
page_title: "Sewan: template_dir"
sidebar_current: "docs-sewan-resource-dir"
description: |-
...
a given source directory and treats every file it encounters as a sewan,
...
* `source_dir` - (Required) Path to the directory where the files to sewan reside.
...
be deleted before sewan rendering begins.
